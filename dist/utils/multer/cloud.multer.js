...
exports.clouduploadfile = exports.filevalidation = exports.storageEnum = void 0;
...
const clouduploadfile = ({ validation = [], storageApproach = storageEnum.memory, maxSizemb = 2 }) => {
    ...
    function filefilter(req, file, callback) {
        if (!validation.includes(file.mimetype)) {
            return callback(new error_response_1.BadRequest("file validation error", {
                validationerror: [{
                        key: "file",
                        issues: [{
                                path: "file",
